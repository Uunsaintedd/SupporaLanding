...
export default function LandingPage() {
  return (
    <main className="bg-white text-gray-900 font-sans">
      {/* Hero Section */}
      <section className="relative text-white py-24 pb-32 text-center">
        {/* Разделённый фон */}
        ...
        <div className="absolute top-6 left-6 w-24 h-24">
          <img src="/logo.png" alt="Suppora Logo" className="w-full h-full" />
        </div>

        <div className="relative container mx-auto px-6 flex flex-col items-center justify-center h-full">
          ...
          <a
            href="#contact"
            className="inline-block bg-purple-500 hover:bg-purple-400 text-white font-semibold py-2 px-6 rounded-xl transition"
          >
            Let’s Talk
          </a>
        </div>
